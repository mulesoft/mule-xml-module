...
/**
 * A {@link ModuleException} associated with the {@link XmlError#INVALID_INPUT_XML} type
 *
 * @since 1.0
 */
public class InvalidInputXmlException extends ModuleException {

  public InvalidInputXmlException(String message, Throwable cause) {
    super(message, INVALID_INPUT_XML, cause);
  }
}
